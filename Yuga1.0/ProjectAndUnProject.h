...
#define SWAP_ROWS_FLOAT(a, b) { double *_tmp = a; (a) = (b); (b) = _tmp; }
...
int _glProject(double objx, double objy, double objz, double *modelview, double *projection, int *viewport, double *windowCoordinate)
{
...
int _glUnProject(double winx, double winy, double winz, double *modelview, double *projection, int *viewport, double *objectCoordinate)
{
